          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              {mediaItems.length > 0 && activeMedia ? (
                ...
                <div className="mb-6">
                  <div className="rounded-xl overflow-hidden bg-gradient-to-r from-indigo-50 to-blue-50 p-6 aspect-video shadow-lg flex flex-col items-center justify-center text-center">
